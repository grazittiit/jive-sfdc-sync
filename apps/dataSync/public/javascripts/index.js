var staticRedirectUrl = "https://grazitti-sfdc-grazitti-sfdc-sync.b9ad.pro-us-east-1.openshiftapps.com/dataSync/sfOauth";
var baseUrl = "https://grazitti-sfdc-grazitti-sfdc-sync.b9ad.pro-us-east-1.openshiftapps.com";
var jiveBaseUrl = "https://grazitti-sfdc-grazitti-sfdc-sync.b9ad.pro-us-east-1.openshiftapps.com/dataSync";
...
$(document).ready(function () {
    ...
    osapi.http.get({
        ...
        console.log("Salesforce  contact fields",salesforceContactFields);
...
oAuthWindow = function () {
    ...
    console.log("inside oauth fnction");
    var loginUrl = document.getElementById('loginUrl').value;
    var salesforceClientId = document.getElementById('salesforceClientId').value;
    var salesforceClientSecret = document.getElementById('salesforceClientSecret').value;
...
saveUserData = function () {
    ...
    osapi.http.post({
        ...
        console.log("Result od save data",res)
